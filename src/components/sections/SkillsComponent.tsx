...
const SkillsComponent = () => {
  return (
    ...
    >
      ...
      {/* Decorative elements */}
      <div className="absolute top-10 left-10 w-72 h-72 bg-[var(--primary-start)]/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-[var(--primary-end)]/10 rounded-full blur-3xl"></div>
